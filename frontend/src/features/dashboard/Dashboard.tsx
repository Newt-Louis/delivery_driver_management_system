...
import { deliveryUnitPresentation, formatTicketCode as formatDynamicTicketCode, unitFallbackColor, unitPresentation } from '../../lib/unitPresentation';

// ─── Ticket code helper ────────────────────────────────────────────────────────
function getTicketCode(d: DeliveryRegistration): string | null {
  return d.ticketNumber ? formatDynamicTicketCode(d.receivingUnit, d.vehicleType, d.ticketNumber, d.unitConfig ?? d.assignedSlot?.zone?.unitConfig) : null;
}
  ...
  function handleExport() {
    downloadCsv('dieu-phoi-hang-cho',
      ...
      filtered.map((d) => [
        ...
        deliveryUnitPresentation(d).label, GOODS_L[d.goodsType] ?? d.goodsType,
