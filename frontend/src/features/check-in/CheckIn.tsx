...
// ─── Ticket code ──────────────────────────────────────────────────────────────
function getTicketCode(delivery: DeliveryRegistration): string {
  return formatDynamicTicketCode(delivery.receivingUnit, delivery.vehicleType, delivery.ticketNumber ?? 0, delivery.unitConfig);
}
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => downloadCsv('xe-dang-cho',
                  ...
                  waitingList.map((d) => [
                    d.ticketNumber != null ? getTicketCode(d) : '',
